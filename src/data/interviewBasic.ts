// 面试突击 — 网络安全基础：26天全量复习 + 14天面试实战 = 40天
...
const mq = (q: string, opts: string[], ans: number[], exp: string): QuizQuestion => ({ question: q, options: opts, correctIndices: ans, explanation: exp });
