...
const books: Book[] = [
  ...
  },
  {
    ...
    subCategory: '靶场实战',
    cover: '靶场',
    description: '从零开始搭建网络安全靶场环境，手把手教你搭建DVWA、SQLi-Labs、Upload-Labs、Pikachu、VulnHub、Vulhub等主流靶场，并完成全部通关实战。45章完整内容，从环境准备到高级Java漏洞(Shiro/Fastjson/Log4j2)、Weblogic中间件、综合靶场方法论与毕业指南，循序渐进，通俗易懂，适合零基础新手入门。',
    pages: 1580,
    difficulty: '入门',
    publishYear: 2026,
    ...
    highlights: [
      '45章完整靶场实战教程，从零到精通',
      'DVWA全模块15章大满贯详解（Day5~Day19）+ 通关指南',
      'SQLi-Labs 75关SQL注入从入门到精通',
      'Upload-Labs 21关文件上传绕过技巧',
      'Pikachu综合靶场全漏洞练习',
      'VulnHub虚拟机靶机实战（Jangow/Kioptrix/DC-1）',
      'Docker + Vulhub漏洞环境复现',
      'Java三大件：Fastjson/Shiro/Log4j2全漏洞精讲',
      'Weblogic全漏洞链(T3/Console/XMLDecoder/JNDI)',
      'IIS+JBoss+综合渗透方法论+CTF/就业路线毕业指南',
      '手把手教学，通俗易懂，新手友好'
    ],
    chapters: [
      ...
      { id: 'ch12', title: '第十二章 DVWA实战 - 不安全的验证码 Insecure CAPTCHA', fileName: 'ch12-DVWA实战-不安全的验证码.md', pageCount: 55 },
      { id: 'ch13', title: '第十三章 DVWA实战 - 弱会话ID与会话劫持 Weak Session IDs', fileName: 'ch13-DVWA实战-弱会话ID.md', pageCount: 50 },
      { id: 'ch14', title: '第十四章 DVWA实战 - 内容安全策略绕过 CSP Bypass', fileName: 'ch14-DVWA实战-CSP绕过.md', pageCount: 50 },
      { id: 'ch15', title: '第十五章 DVWA实战 - JavaScript Attacks前端JS闯关', fileName: 'ch15-DVWA实战-JS攻击闯关.md', pageCount: 50 },
      { id: 'ch16', title: '第十六章 DVWA实战 - SQL盲注 SQL Injection (Blind)', fileName: 'ch16-DVWA实战-SQL盲注.md', pageCount: 60 },
      { id: 'ch17', title: '第十七章 DVWA实战 - 开放式重定向 Open HTTP Redirect', fileName: 'ch17-DVWA实战-开放重定向.md', pageCount: 45 },
      { id: 'ch18', title: '第十八章 HTTP头注入(CRLF) + DVWA全模块彩蛋查漏', fileName: 'ch18-DVWA实战-HTTP头注入+彩蛋.md', pageCount: 55 },
      { id: 'ch19', title: '第十九章 DVWA通关毕业典礼 + 后续学习路线总规划 🎓', fileName: 'ch19-DVWA毕业典礼与路线规划.md', pageCount: 40 },
      { id: 'ch20', title: '第二十章 SQLi-Labs搭建与基础注入Less1-10', fileName: 'ch20-SQLi-Labs搭建与基础注入Less1-10.md', pageCount: 60 },
      { id: 'ch21', title: '第二十一章 SQLi-Labs进阶注入Less11-25', fileName: 'ch21-SQLi-Labs进阶注入Less11-25.md', pageCount: 65 },
      { id: 'ch22', title: '第二十二章 SQLi-Labs盲注与绕过Less26-40', fileName: 'ch22-SQLi-Labs盲注与绕过Less26-40.md', pageCount: 70 },
      { id: 'ch23', title: '第二十三章 SQLi-Labs高级注入Less41-55', fileName: 'ch23-SQLi-Labs高级注入Less41-55.md', pageCount: 70 },
      { id: 'ch24', title: '第二十四章 SQLi-Labs终极挑战Less56-75', fileName: 'ch24-SQLi-Labs终极挑战Less56-75.md', pageCount: 75 },
      { id: 'ch25', title: '第二十五章 SQL注入神器sqlmap使用指南', fileName: 'ch25-SQL注入神器sqlmap使用指南.md', pageCount: 55 },
      { id: 'ch26', title: '第二十六章 Upload-Labs搭建与前端绕过Pass1-7', fileName: 'ch26-Upload-Labs搭建与前端绕过Pass1-7.md', pageCount: 50 },
      { id: 'ch27', title: '第二十七章 Upload-Labs后缀绕过与解析漏洞Pass8-15', fileName: 'ch27-Upload-Labs后缀绕过与解析漏洞Pass8-15.md', pageCount: 60 },
      { id: 'ch28', title: '第二十八章 Upload-Labs图片马与高级绕过Pass16-21', fileName: 'ch28-Upload-Labs图片马与高级绕过Pass16-21.md', pageCount: 65 },
      { id: 'ch29', title: '第二十九章 Pikachu靶场搭建与XSS全关卡', fileName: 'ch29-Pikachu靶场搭建与XSS全关卡.md', pageCount: 55 },
      { id: 'ch30', title: '第三十章 Pikachu靶场SQL注入与文件上传', fileName: 'ch30-Pikachu靶场SQL注入与文件上传.md', pageCount: 50 },
      { id: 'ch31', title: '第三十一章 Pikachu其他漏洞与靶场总结', fileName: 'ch31-Pikachu其他漏洞与靶场总结.md', pageCount: 45 },
      { id: 'ch32', title: '第三十二章 VMware与Kali配置优化', fileName: 'ch32-VMware与Kali配置优化.md', pageCount: 45 },
      { id: 'ch33', title: '第三十三章 Jangow 1.0.1靶机搭建与信息收集', fileName: 'ch33-Jangow-1.0.1靶机搭建与信息收集.md', pageCount: 55 },
      { id: 'ch34', title: '第三十四章 Jangow 1.0.1完整渗透通关教程', fileName: 'ch34-Jangow-1.0.1完整渗透通关教程.md', pageCount: 70 },
      { id: 'ch35', title: '第三十五章 Kioptrix Level 1完整渗透流程', fileName: 'ch35-Kioptrix-Level-1完整渗透流程.md', pageCount: 75 },
      { id: 'ch36', title: '第三十六章 Docker安装与Vulhub环境搭建', fileName: 'ch36-Docker安装与Vulhub环境搭建.md', pageCount: 50 },
      { id: 'ch37', title: '第三十七章 Web框架漏洞复现ThinkPHP S2等', fileName: 'ch37-Web框架漏洞复现ThinkPHP-S2等.md', pageCount: 65 },
      { id: 'ch38', title: '第三十八章 中间件漏洞复现Apache Nginx Tomcat', fileName: 'ch38-中间件漏洞复现Apache-Nginx-Tomcat.md', pageCount: 70 },
      { id: 'ch39', title: '第三十九章 DC-1靶机实战与学习路线总结', fileName: 'ch39-DC-1靶机实战与学习路线总结.md', pageCount: 80 },
      { id: 'ch40', title: '第四十章 Fastjson全版本漏洞深度精讲', fileName: 'ch40-Fastjson全版本漏洞深度精讲.md', pageCount: 90 },
      { id: 'ch41', title: '第四十一章 Shiro反序列化完全攻略', fileName: 'ch41-Shiro反序列化完全攻略.md', pageCount: 85 },
      { id: 'ch42', title: '第四十二章 Log4j2 Log4Shell完全利用手册', fileName: 'ch42-Log4j2-Log4Shell完全利用手册.md', pageCount: 95 },
      { id: 'ch43', title: '第四十三章 Weblogic全漏洞链实战', fileName: 'ch43-Weblogic全漏洞链实战.md', pageCount: 100 },
      { id: 'ch44', title: '第四十四章 综合靶场实战方法论', fileName: 'ch44-综合靶场实战方法论.md', pageCount: 105 },
      { id: 'ch45', title: '第四十五章 毕业总结-Web安全全景与职业路线', fileName: 'ch45-毕业总结-Web安全全景与职业路线.md', pageCount: 90 },
    ]
  },
  {
