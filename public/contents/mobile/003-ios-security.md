...
>
> 系统讲解 iOS 应用安全测试的全流程：越狱环境搭建/IPA 逆向分析/运行时 Hook/数据存储安全/网络通信分析及二进制保护。

---

## 导航目录

- [一、iOS 安全架构基础](#一ios-安全架构基础)
- [二、越狱环境搭建](#二越狱环境搭建)
- [三、IPA 逆向分析](#三ipa-逆向分析)
- [四、运行时 Hook 与调试](#四运行时-hook-与调试)
- [五、数据与网络安全测试](#五数据与网络安全测试)
