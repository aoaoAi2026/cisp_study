...
> **📘 文档定位**：CISP 考试 渗透测试 高级 | 难度：⭐⭐⭐⭐ | 预计阅读：28 分钟
>
> 系统整理 Linux 提权的全链路手法：SUID/GUID/Capabilities/Cron/内核漏洞/Docker逃逸/敏感文件读取/NFS 等，是后渗透阶段的核心技能。
...
- [一、信息收集与枚举](#一信息收集与枚举)
- [二、SUID/GUID 提权](#二suidguid-提权)
- [三、内核漏洞提权](#三内核漏洞提权)
- [四、计划任务/Cron 提权](#四计划任务cron-提权)
- [五、Docker/容器逃逸](#五docker容器逃逸)
