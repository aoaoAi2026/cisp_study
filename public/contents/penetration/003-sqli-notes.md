...
> **📘 文档定位**：CISP 考试 渗透测试 核心 | 难度：⭐⭐⭐⭐ | 预计阅读：30 分钟
>
> 系统讲解 SQL 注入的完整知识体系：从联合查询到报错注入、布尔盲注、时间盲注、堆叠注入，覆盖 MySQL/MSSQL/Oracle 多种数据库及 WAF 绕过技术。

---

## 导航目录

- [一、SQL 注入基础原理](#一sql-注入基础原理)
- [二、联合查询注入](#二联合查询注入)
- [三、报错注入](#三报错注入)
- [四、布尔/时间盲注](#四布尔时间盲注)
- [五、堆叠注入与二次注入](#五堆叠注入与二次注入)
- [六、WAF 绕过技术](#六waf-绕过技术)
