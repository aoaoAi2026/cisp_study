...
> 全球 AI 监管进入加速期，欧盟 AI Act、中国生成式 AI 管理办法、美国行政令三足鼎立。本文系统梳理三大监管体系对比、AI 偏见与公平性评估、可解释 AI 技术及红队测试方法论，是 AI 合规方向的核心考点。

---

## 导航目录
- [一、全球AI监管格局](#一全球ai监管格局)
- [二、AI偏见与公平性](#二ai偏见与公平性)
- [三、可解释AI (XAI)](#三可解释ai-xai)
- [四、AI红队测试](#四ai红队测试)
...
| 序号 | 考点 | 频率 | 难度 | 关键答案 |
|:---:|:---|:---:|:---:|:---|
| 1 | 欧盟 AI Act 四级风险分类 | ⭐⭐⭐⭐⭐ | ⭐⭐ | 不可接受（禁止）、高风险（严格监管）、有限风险（透明度）、最小风险（无义务） |
| 2 | 中国生成式AI监管核心要求 | ⭐⭐⭐⭐⭐ | ⭐⭐ | 算法备案、安全评估、训练数据合规、内容安全、用户权益 |
| 3 | AI偏见五大来源 | ⭐⭐⭐⭐ | ⭐⭐⭐ | 历史偏见、表征偏见、测量偏见、聚合偏见、评估偏见 |
| 4 | 公平性三大指标 | ⭐⭐⭐⭐ | ⭐⭐⭐ | Demographic Parity（人口均等）、Equalized Odds（均等几率）、Equal Opportunity（均等机会） |
| 5 | SHAP vs LIME | ⭐⭐⭐ | ⭐⭐⭐ | SHAP基于博弈论有理论保证，LIME局部线性近似更快速 |
| 6 | AI红队测试三方面 | ⭐⭐⭐ | ⭐⭐ | 安全测试（注入/越狱）、伦理测试（偏见/有害）、合规测试（备案/标识） |

### 知识巧记口诀
> 🎵 **全球监管三巨头**："欧盟AI Act风险分级，中国算法备案安全评估，美国行政令自愿承诺——三足鼎立各不同"

> 🎵 **偏见五来源**："历史数据有偏差，表征群体不均衡；测量标准存偏颇，聚合一刀切众人；评估基准不符实——五源偏见需谨记"

> 🎵 **公平性三指标**："人口均等看预测率，均等几率查真假阳，均等机会只看真阳——从宽到严选指标"

---

> **AI 合规不是选择题而是必答题。全球监管趋严，掌握欧盟 AI Act、中国生成式 AI 管理办法、公平性评估三大核心知识，是 AI 安全从业者的基本素养。**
