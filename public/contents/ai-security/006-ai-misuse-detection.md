...
> 生成式 AI 被恶意滥用于 Deepfake 换脸、AI 钓鱼邮件、自动化攻击代码生成等场景。本文从攻防双视角深入剖析 Deepfake 生成与检测技术、AI 增强钓鱼攻击链、AI 生成文本检测及企业级五层防御体系。

---

## 导航目录
- [一、AIGC 恶意滥用全景](#一aigc-恶意滥用全景)
- [二、Deepfake 技术剖析](#二deepfake-技术剖析)
- [三、AI钓鱼攻击](#三ai钓鱼攻击)
- [四、检测与防御](#四检测与防御)
- [五、AI安全工具链](#五ai安全工具链)
...
| 序号 | 考点 | 频率 | 难度 | 关键答案 |
|:---:|:---|:---:|:---:|:---|
| 1 | Deepfake 生成四大技术路线 | ⭐⭐⭐⭐ | ⭐⭐ | 视频换脸、人脸重建、实时换脸、语音克隆 |
| 2 | AI钓鱼 vs 传统钓鱼核心区别 | ⭐⭐⭐⭐⭐ | ⭐⭐ | AI钓鱼：个性化+无语法错误+上下文感知，效率从5%提升到90% |
| 3 | Deepfake 检测三类方法 | ⭐⭐⭐⭐ | ⭐⭐⭐ | 空间域（面部伪影）、时域（帧间闪烁）、频域（GAN指纹） |
| 4 | AI文本检测指标 | ⭐⭐⭐ | ⭐⭐⭐ | 困惑度（Perplexity）+ 突发度（Burstiness），AI低困惑度低突发度 |
| 5 | 企业五层防御体系 | ⭐⭐⭐ | ⭐⭐ | 邮件网关→终端安全→身份认证→安全意识→AI检测平台 |
| 6 | 生物信号反Deepfake | ⭐⭐⭐ | ⭐⭐⭐ | 心率检测（PPG信号）、呼吸模式、微表情——Deepfake难以伪造 |

### 知识巧记口诀
> 🎵 **Deepfake检测**："空间找伪影，时域看闪烁；频域查指纹，生物信号最可靠"

> 🎵 **AI钓鱼防御**："邮件网关第一关，终端隔离第二关；身份认证加活体，安全意识是底线；AI检测最后关，五层防御保安全"

> 🎵 **AI滥用四大场景**："换脸冒充身份、语音克隆CEO、钓鱼邮件精准骗、假新闻批量造"

---

> **生成式 AI 的双刃剑效应日益显著。防御方必须用 AI 对抗 AI——AI 钓鱼需 AI 检测、Deepfake 需 AI 识别，在这场不对称战争中，技术+意识+流程缺一不可。**
