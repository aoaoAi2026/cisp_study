...
> **📘 文档定位**：CISP 考试 V2X 安全高级专题 | 难度：⭐⭐⭐⭐⭐ | 预计阅读：28 分钟
>
> 深入对比功能安全（ISO 26262）与预期功能安全（SOTIF/ISO 21448）的核心差异，解析 ASIL 等级评定方法、安全目标导出过程，以及自动驾驶系统（ADS）的安全验证与确认策略，覆盖 L0-L5 各等级的安全考量。

---

## 导航目录

- [一、功能安全 (ISO 26262)](#一功能安全-iso-26262)
- [二、ASIL 等级与安全目标](#二asil-等级与安全目标)
- [三、预期功能安全 SOTIF (ISO 21448)](#三预期功能安全-sotif-iso-21448)
- [四、自动驾驶安全验证与确认](#四自动驾驶安全验证与确认)
- [五、AI/ML 安全挑战](#五aiml-安全挑战)
...
| 序号 | 考点 | 频率 | 难度 | 关键答案 |
|:---:|:---|:---:|:---:|:---|
| 1 | ISO 26262 功能安全 | ⭐⭐⭐⭐⭐ | ⭐⭐⭐⭐ | ASIL A/B/C/D 四级，危害分析与风险评估(HARA) |
| 2 | SOTIF (ISO 21448) | ⭐⭐⭐⭐⭐ | ⭐⭐⭐⭐ | 预期功能安全，解决传感器局限和算法不确定性 |
| 3 | ASIL 分解原理 | ⭐⭐⭐⭐ | ⭐⭐⭐⭐ | ASIL D → ASIL B(D)+ASIL B(D)，冗余降级 |
| 4 | Fail-Operational 设计 | ⭐⭐⭐⭐ | ⭐⭐⭐ | L3+自动驾驶需失效可操作，冗余是关键 |
| 5 | 感知安全威胁 | ⭐⭐⭐⭐ | ⭐⭐⭐ | 对抗样本/传感器欺骗/GPS欺骗/激光雷达干扰 |
| 6 | Safety Case 编制 | ⭐⭐⭐ | ⭐⭐⭐⭐ | 结构化安全论证，证明系统达到可接受安全水平 |

### 知识巧记口诀

> 🎵 **ASIL 四级记**："A 轻 B 中 C 重 D 致命" — 严重度+暴露率+可控性三维评定
>
> 🎵 **安全三姐妹**："26262管功能，21448管预期，8800管AI" — 功能安全+SOTIF+AI安全
>
> 🎵 **自动驾驶三防线**："感知准、决策稳、执行可靠" — 传感器冗余+算法验证+Fail-Op
...
| 陷阱 | 正确理解 |
|:---|:---|
| "功能安全=SOTIF" | ❌ 功能安全处理系统故障，SOTIF 处理功能不足（传感器没坏但看不清） |
| "ASIL D 是最高等级就是最安全的" | ❌ ASIL 不是绝对值，是对特定危害事件的评级，不同场景独立评定 |
| "L4/L5 自动驾驶不需要人类接管" | ❌ 但仍需远程操作员(Remote Operator)作为备份安全机制 |

---

> **自动驾驶安全的本质是"不确定性管理"——功能安全管已知故障，SOTIF 管未知边界，两者合力才能让 AI 方向盘安全上路。**
