...
> **📘 文档定位**：CISP 考试 漏洞分析 核心 | 难度：⭐⭐⭐⭐⭐ | 预计阅读：30 分钟
>
> 深度解析 Log4Shell (CVE-2021-44228) 的 JNDI 注入原理、Lookup 机制、绕过技术及完整 EXP 实战，是理解 Java 反序列化与 JNDI 安全的里程碑级案例。
...
- [一、漏洞概述](#一漏洞概述)
- [二、JNDI/LDAP 注入原理](#二jndildap-注入原理)
- [三、EXP 利用实战](#三exp-利用实战)
- [四、绕过技术](#四绕过技术)
- [五、检测与修复](#五检测与修复)
