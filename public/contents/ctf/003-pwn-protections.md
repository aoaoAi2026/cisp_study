...
>
> 深入讲解 Pwn 方向保护机制的底层原理与绕过技术，覆盖 Canary 泄露/NX ROP/ASLR 爆破/PIE 基址泄露等核心技术。

---

## 导航目录

- [一、保护机制底层原理](#一保护机制底层原理)
- [二、Canary 泄露与绕过](#二canary-泄露与绕过)
- [三、NX/ASLR/PIE 组合绕过](#三nxaslrpie-组合绕过)
- [四、高级 ROP 技术](#四高级-rop-技术)
- [五、实战练习路径](#五实战练习路径)
