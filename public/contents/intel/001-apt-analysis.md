...
> **📘 文档定位**：CISP 考试威胁情报核心内容 | 难度：⭐⭐⭐⭐ | 预计阅读：25 分钟
> APT 攻击是国家级网络安全威胁的最高形态。本文从 APT 组织画像、攻击链分析到溯源归因，系统梳理 APT 威胁分析知识体系。

---

## 导航目录
- [一、APT 的本质：高级持续威胁](#一apt-的本质高级持续威胁)
...
> 🔑 **高分考点**：APT 组织分析考点集中在 APT 三大特征、Kill Chain 七步、知名 APT 组织 TTPs 画像。

| 考点 | 频次 | 核心记忆点 |
|:---|:---:|:---|
| APT 三大特征 | ⭐⭐⭐⭐⭐ | Advanced(高级手段)、Persistent(持续潜伏)、Threat(真实威胁) |
| Kill Chain 七步 | ⭐⭐⭐⭐ | 侦察→武器化→投递→利用→安装→C2→行动 |
| 海莲花(OceanLotus) | ⭐⭐⭐⭐ | 鱼叉+水坑+供应链，DLL Side-Loading，越南政府背景 |
| 蔓灵花(Temp.Periscope) | ⭐⭐⭐ | .lnk+VBS/JS，伪装客户，中国海事目标 |

> 💡 **知识巧记**：Kill Chain 七步记"侦武投利装控行"——侦察、武器化、投递、利用、安装、C2、行动。APT 组织记"海蔓响"——海莲花(越南)、蔓灵花(中国海事)、响尾蛇(南亚)。

### 高分考点速查表

| 考察维度 | 关键结论 | 常见干扰项 |
|:---|:---|:---|
| APT vs 普通黑客 | 国家级背景、长期潜伏、定制化工具 | "APT 就是高级黑客" ❌ |
| IOC vs TTPs | TTPs 比 IOC 更持久，行为特征更可靠 | "IOC 永不过期" ❌ |

### 知识巧记口诀

> **APT 分析口诀**：
> APT 三特征高持威，Kill Chain 七步侦武投利装控行。
> 海莲花鱼叉加水坑，蔓灵花 lnk 脚本 VBS 行。
> IOC 有时效 TTPs 持久，防御需纵深检测响应并进。
