...
> **📘 文档定位**：CISP 考试威胁检测核心框架 | 难度：⭐⭐⭐⭐ | 预计阅读：22 分钟
> MITRE ATT&CK 是全球公认的对手战术知识库。本文从框架结构、矩阵解读到检测工程化，系统梳理 ATT&CK 在安全运营中的应用。

---

## 导航目录
- [一、ATT&CK 框架概览](#一attck-框架概览)
...
> 🔑 **高分考点**：MITRE ATT&CK 考点集中在矩阵结构、战术与技术的关系、检测映射。

| 考点 | 频次 | 核心记忆点 |
|:---|:---:|:---|
| ATT&CK 矩阵 | ⭐⭐⭐⭐⭐ | 14 战术 + 200+ 技术 + 子技术，三大矩阵(Enterprise/Mobile/ICS) |
| 战术 vs 技术 | ⭐⭐⭐⭐ | 战术是"为什么"(目标)，技术是"怎么做"(手段) |
| 检测覆盖 | ⭐⭐⭐⭐ | 安全告警映射 ATT&CK ID → 覆盖度分析 |

> 💡 **知识巧记**：战术 14 项首字记"侦资初执持提防发凭收令渗横集泄影"。

### 高分考点速查表

| 考察维度 | 关键结论 | 常见干扰项 |
|:---|:---|:---|
| ATT&CK 用途 | 攻击模拟、检测覆盖、红蓝对抗、威胁情报 | "ATT&CK 只是攻击工具库" ❌ |
| Kill Chain vs ATT&CK | Kill Chain 关注阶段，ATT&CK 关注具体行为 | "两者完全一样" ❌ |
