...
>
> 系统整理 SOC 最常用的 10 大自动化响应剧本模板，覆盖钓鱼邮件/恶意软件/DDoS/数据泄露/暴力破解/WebShell 等典型场景。

---

## 导航目录

- [一、Playbook 设计原则](#一playbook-设计原则)
- [二、钓鱼邮件响应剧本](#二钓鱼邮件响应剧本)
- [三、恶意软件响应剧本](#三恶意软件响应剧本)
- [四、DDoS 响应剧本](#四ddos-响应剧本)
- [五、数据泄露响应剧本](#五数据泄露响应剧本)
