...
> **📘 文档定位**：CISP 考试 应急响应 核心 | 难度：⭐⭐⭐⭐ | 预计阅读：28 分钟
>
> 系统讲解 Windows EDR 告警的分析方法论，覆盖进程链/网络/文件/注册表/计划任务多维度关联分析，帮助安全分析师快速从告警中判断真实威胁并执行响应。

---

## 导航目录

- [一、EDR 告警分析框架](#一edr-告警分析框架)
- [二、进程链分析](#二进程链分析)
- [三、网络连接分析](#三网络连接分析)
- [四、文件与注册表分析](#四文件与注册表分析)
- [五、常见告警场景与响应](#五常见告警场景与响应)
