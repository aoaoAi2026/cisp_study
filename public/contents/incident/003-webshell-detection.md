...
>
> 系统讲解 WebShell 的检测方法论（特征匹配/行为分析/日志溯源）、手工排查与自动工具结合技巧、WebShell 清除与后门扫描工具实战，覆盖 PHP/JSP/ASPX 全类型 WebShell 的应急响应全流程。

---

## 导航目录

- [一、WebShell 概述与分类](#一webshell-概述与分类)
- [二、WebShell 检测方法论](#二webshell-检测方法论)
- [三、手工排查实战](#三手工排查实战)
- [四、自动工具扫描](#四自动工具扫描)
- [五、WebShell 清除与加固](#五webshell-清除与加固)
