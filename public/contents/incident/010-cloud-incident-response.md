...
> **📘 文档定位**：CISP 考试 应急响应 高级专题 | 难度：⭐⭐⭐⭐ | 预计阅读：28 分钟
>
> 系统讲解云环境（AWS/阿里云/腾讯云）安全事件的应急处置流程，覆盖云控制台/API/存储/容器/K8s 等多维度的入侵排查与响应方法，是云安全应急响应的核心指南。
...
- [一、云安全事件分类](#一云安全事件分类)
- [二、云控制台安全排查](#二云控制台安全排查)
- [三、云存储安全事件](#三云存储安全事件)
- [四、容器与 K8s 安全事件](#四容器与-k8s-安全事件)
- [五、云日志取证与分析](#五云日志取证与分析)
