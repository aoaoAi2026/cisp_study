...
> **📘 文档定位**：CISP 考试 应急响应 高级专题 | 难度：⭐⭐⭐⭐⭐ | 预计阅读：35 分钟
>
> 系统讲解 APT（高级持续性威胁）事件的应急响应全流程，覆盖 ATT&CK 矩阵映射/攻击链还原/溯源反制/持久化清除等核心技术，是高级应急响应人员应对国家级攻击的行动手册。

---

## 导航目录

- [一、APT 攻击特征识别](#一apt-攻击特征识别)
- [二、ATT&CK 矩阵映射](#二attck-矩阵映射)
- [三、攻击链还原](#三攻击链还原)
- [四、持久化机制排查](#四持久化机制排查)
- [五、溯源反制](#五溯源反制)
