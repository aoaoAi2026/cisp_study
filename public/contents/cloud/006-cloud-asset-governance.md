...
> **📘 文档定位**：CISP 考试云安全管理核心内容 | 难度：⭐⭐⭐ | 预计阅读：18 分钟
> 云上资产弹性多变，传统台账式管理完全失效。本文从统一 CMDB 建设、暴露面收敛、影子资产发现到自动化治理，系统梳理云上资产安全管理全链路。

---

## 导航目录
- [一、云上资产安全面临的三大难题](#一云上资产安全面临的三大难题)
- [二、统一 CMDB 建设要点](#二统一-cmdb-建设要点)
- [三、暴露面收敛与风险量化](#三暴露面收敛与风险量化)
- [四、影子资产与匿名资源发现](#四影子资产与匿名资源发现)
- [五、攻击面收敛自动化](#五攻击面收敛自动化)
- [六、治理 CheckList](#六治理-checklist)
...
> 🔑 **高分考点**：云资产管理考点集中在暴露面风险识别、影子资产成因、标签治理最佳实践。考试侧重"什么资产最容易被遗忘"和"如何发现异常资产"。

| 考点 | 频次 | 核心记忆点 |
|:---|:---:|:---|
| 云资产三大特征 | ⭐⭐⭐⭐⭐ | 弹性、分布式、易被遗忘 |
| 影子资产成因 | ⭐⭐⭐⭐ | 个人 AK/SK 创建、测试环境忘销毁、Terraform 孤儿资源 |
| 高风险暴露面 | ⭐⭐⭐⭐ | SSH/RDP 公网、Redis 无认证、S3 公开、数据库公网 |
| 标签治理 | ⭐⭐⭐ | 6 个强制标签：Owner/Business/Environment/CostCenter/Confidentiality/Compliance |
| 自动化治理 | ⭐⭐⭐ | Cloud Custodian 策略驱动，自动关停/隔离不合规资源 |

> 💡 **知识巧记**：云资产三特征记"弹分忘"——弹性扩缩、分布式部署、易被遗忘。六标签记"主业环成密合"——Owner 主人、Business 业务、Environment 环境、CostCenter 成本、Confidentiality 密级、Compliance 合规。高风险暴露面口诀：22/3389 公网开，6379/27017 无认证，S3/OSS 公开桶，数据库绑公网 IP。

### 高分考点速查表

| 考察维度 | 关键结论 | 常见干扰项 |
|:---|:---|:---|
| CMDB 核心 | 云原生 API 自动采集 + 人工标注双模式 | "手工台账即可" ❌ |
| 影子资产 | 不在 CMDB 中的资源，标签缺失是首要信号 | "影子资产只有未使用的资源" ❌ |
| 端口暴露 | 22/3389 开 0.0.0.0/0 属于严重风险 | "仅内网暴露无需关注" ❌ |
| Block Public Access | S3/OSS 应默认开启，组织级 SCP 强制 | "按需单独配置即可" ❌ |
| 标签作用 | 责任到人、成本分摊、合规标记、自动治理 | "标签只是分类标记" ❌ |

### 知识巧记口诀

> **云资产治理口诀**：
> 弹分忘三特征记心间，CMDB 自动采集加人标。
> 标签六项不可缺，主业环成密合全。
> 暴露端口严收敛，22/3389 禁公网连。
> 影子资产定期扫，无主孤儿及时关。
> S3/OSS 公访锁，Cloud Custodian 自动管。
