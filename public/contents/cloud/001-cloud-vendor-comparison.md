...
> **📘 文档定位**：CISP 考试云安全核心基础 | 难度：⭐⭐⭐ | 预计阅读：15 分钟
> 三大云厂商在安全产品线上各有侧重。本文从六大安全维度横向对比阿里云、腾讯云、AWS 的安全能力，并提供多云统一安全中台架构与选型建议。

---

## 导航目录
- [一、三大云厂商安全能力横向对比](#一三大云厂商安全能力横向对比)
- [二、云厂商共性安全风险与规避思路](#二云厂商共性安全风险与规避思路)
- [三、选型与最佳实践建议](#三选型与最佳实践建议)
- [四、高分考点与知识巧记](#四高分考点与知识巧记)
...
| 序号 | 考点 | 频率 | 难度 | 关键答案 |
|:---:|:---|:---:|:---:|:---|
| 1 | 三大云厂商安全差异 | ⭐⭐⭐⭐ | ⭐⭐ | 阿里云产品最全、腾讯云内容安全强、AWS 合规覆盖最广 |
| 2 | 云安全四大共性风险 | ⭐⭐⭐⭐⭐ | ⭐⭐ | AK/SK泄露、控制台越权、网络暴露面过大、审计日志缺失 |
| 3 | AK/SK 泄露检测工具 | ⭐⭐⭐ | ⭐⭐ | trufflehog、gitleaks 扫描 Git 历史和代码仓库 |
| 4 | 多云统一安全五层 | ⭐⭐⭐ | ⭐⭐ | 账号层→网络层→主机层→数据层→审计层 |
| 5 | 云厂商选型建议 | ⭐⭐⭐ | ⭐⭐ | 电商选阿里云、游戏内容选腾讯云、出海选AWS |

### 知识巧记口诀
> 🎵 **云厂商对比**："阿里安全产品全，腾讯内容风控强；AWS 合规覆盖广，多云中台统一管"

> 🎵 **云安全四险**："密钥泄露第一险，控制台越权第二险；网络暴露第三险，审计缺失第四险——四险齐防云无忧"
